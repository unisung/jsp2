...
<%
    ...
    fruit1.setKind("사과"); fruit1.setPrice(3000);
    request.setAttribute("apple",fruit1);
    
    fruit1 = new Fruit();
    fruit1.setKind("포도"); fruit1.setPrice(5000);
    session.setAttribute("grape", fruit1);
    
    fruit1 = new Fruit();
    fruit1.setKind("망고"); fruit1.setPrice(7000);
    application.setAttribute("mango", fruit1);
    
    fruit1 = new Fruit();
    fruit1.setKind("바나나"); fruit1.setPrice(9000);
